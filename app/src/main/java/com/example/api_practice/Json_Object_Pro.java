        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!id.equals("")){
                    ...
                    Toast.makeText(Json_Object_Pro.this, "Please Enter the id", Toast.LENGTH_SHORT).show();
                }
            }
        });
